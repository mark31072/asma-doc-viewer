...
MSDocRenderer.fileTypes = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], MSDocFTMaps.doc), MSDocFTMaps.docx), MSDocFTMaps.xls), MSDocFTMaps.xlsx), MSDocFTMaps.ppt), MSDocFTMaps.pptx);
